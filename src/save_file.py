...
class saver:
    def __init__(self, parent):
        ...
        for obj in self.AL:
                ...
                if dxf:
                    ...
                    for i in lines:
                        ...
                        if ('priv' in tag) and ('dim_text' not in tag):
                            ...
                            lines_coord.update({'line_'+str(num_lines)+'_x1': coord[0],
                                                'line_'+str(num_lines)+'_y1': -coord[1],
                                                'line_'+str(num_lines)+'_x2': coord[2],
                                                'line_'+str(num_lines)+'_y2': -coord[3]})
                            ...
                            lines_coord.update({'arrow_'+str(num_arrows)+'_x1': coord[0],
                                                'arrow_'+str(num_arrows)+'_y1': -coord[1],
                                                'arrow_'+str(num_arrows)+'_x2': coord[2],
                                                'arrow_'+str(num_arrows)+'_y2': -coord[3]})
                    ...
                    if config['ort'] == "horizontal":
                        config.update({'arrow_point1_x': coord_list[2][0],
                                        'arrow_point1_y': -coord_list[0][1],
                                        'arrow_point2_x': coord_list[2][0],
                                        'arrow_point2_y': -coord_list[1][1]})
                        ...
                        config.update({'arrow_point1_x': coord_list[0][0],
                                        'arrow_point1_y': -coord_list[2][1],
                                        'arrow_point2_x': coord_list[1][0],
                                        'arrow_point2_y': -coord_list[2][1],
                                        'angle': 0.0,
                                        'angle_arrow1': 180.0,
                                        'angle_arrow2': 0.0})
                        if config['type_arrow'] == 'Arrow':
                            config.update({'arrow_5_y': -coord_list[2][1],   
                                        'arrow_5_x': lines_coord['arrow_1_x1'],
                                        'arrow_6_y': -coord_list[2][1],
            ...
            elif obj[0] == 't':#'text' in self.AL[obj]['object']:
